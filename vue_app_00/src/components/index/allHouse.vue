<template>
    <div class="all_house">
       <div class="top-input">
        ...
        <div class="btn">
            <div><button>日期</button></div>
            <div><button>人数</button></div>
...
<script>
import Carouselt from "./Carousel2"
export default {
    data() {
        return {
...
.all_house .btn div:not(:first-child) {
    margin-left:10px;
}
.all_house .btn div button{
    padding:2px 5px;
    border-radius:5px;
    outline: none;
...
.allhouse_spice span:first-child{
    font-size: 15px;
    font-weight: 600;
    margin-bottom: 10px;
}
